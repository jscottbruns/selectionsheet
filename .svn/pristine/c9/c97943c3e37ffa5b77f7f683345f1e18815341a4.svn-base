<?php
/** $Id: example3.php 2034 2005-11-29 18:20:21Z jrust $ */
/**
...
<body>
  ...
  This should open straight into your PDF reader, but, if not, click <a href="<?php echo $linkToPDF; ?>">here</a> to view the PDF file.<br />
