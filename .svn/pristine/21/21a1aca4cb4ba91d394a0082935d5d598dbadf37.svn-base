...
var menu2=new Array()
menu2[0]="<table id='tablinks' cellspacing=1 cellpadding='4' style='width:180%;font-weight:bold;font-size:11;'><tr class=linkOff onMouseOver=this.className='linkOn' onMouseOut=this.className='linkOff' onClick=window.location='errorReporting.php?report=predefault'><td  >Default : Pre Task Error Check</td></tr><tr class=linkOff onMouseOver=this.className='linkOn' onMouseOut=this.className='linkOff' onClick=window.location='errorReporting.php?report=preactive'><td  >Running Schedules : Pre Task Error Check</td></tr></table>"

//Contents for menu 2, and so on
var menu3=new Array()
menu3[0]="<table id='tablinks' cellspacing=1 cellpadding='4' style='width:100%;font-weight:bold;font-size:11;'><tr class=linkOff onMouseOver=this.className='linkOn' onMouseOut=this.className='linkOff' onClick=window.location='forum.php'><td  >Discussion Forum</td></tr><tr class=linkOff onMouseOver=this.className='linkOn' onMouseOut=this.className='linkOff' onClick=window.location='messages.php'><td  >Check & Send Email</td></tr></table>"

//Contents for menu 2, and so on
var menu4=new Array()
menu4[0]="<table id='tablinks' cellspacing=1 cellpadding='4' style='width:100%;font-weight:bold;font-size:11;'><tr class=linkOff onMouseOver=this.className='linkOn' onMouseOut=this.className='linkOff' onClick=window.location='admin.php?cmd=unregister'><td>Un Register a User</td></tr><tr class=linkOff onMouseOver=this.className='linkOn' onMouseOut=this.className='linkOff' onClick=window.location='admin.php?cmd=allusers'><td>All Users</td></tr></table>"
