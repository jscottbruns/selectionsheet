...
if ($_REQUEST['eventID']) {
	...
	$submitBtn = submit("apptBtn","Update")."\n&nbsp;".submit("apptBtn","Delete");
	echo hidden(array("updateID" => $eventID));
	if ($row['repeat']) {
		$_REQUEST['apply'] = 1;
		
		$applyStr = "
		<span style=\"padding:15px;background-color:#dddddd;border:1px solid #C1C1C1;\">
...
for ($i = 0; $i < count($lots->lot_hash); $i++) {
	if ($lots->status[$i] == "SCHEDULED") {
		$lotArray[] = $lots->community[$i].", ".$lots->lot_no[$i];
		$lotArrayInside[] = $lots->lot_community_hash[$i]."|".$lots->lot_hash[$i];
	}
}
...
<table style=\"width:100%;\">
	<tr>
		<td class=\"smallfont\">
			<table style=\"width:100%;\" >
				<tr>
					<td colspan=\"2\">
						<h2 style=\"color:#0A58AA;\">Add Event</h2>
					</td>
				</tr>
				<tr>
	...
	<tr>
		<td style=\"margin-top:0\">
			<table style=\"background-color:#efefef;border:1px solid #C1C1C1;\" cellpadding=\"6\">
				<tr>
					<td class=\"smallfont\" style=\"width:75px;font-weight:bold;\">&nbsp;</td>
					<td class=\"smallfont\">&nbsp;</td>
				</tr>
				<tr>
					<td class=\"smallfont\" style=\"width:75px;font-weight:bold;\">$err[0]Title: </td>
					<td class=\"smallfont\">".text_box("title",$_REQUEST['title'],50,80)."</td>
				</tr>
				<tr>
					<td colspan=\"2\"><hr style=\"width:95%;text-align:left\"></td>
				</tr>
				<tr>
					<td class=\"smallfont\" style=\"width:75px;font-weight:bold;\">Event Type: </td>
				...
				<tr>
					<td class=\"smallfont\" style=\"width:75px;font-weight:bold;\">Location: </td>
					<td class=\"smallfont\">".text_box("location",$_REQUEST['location'],50,128)."</td>
				</tr>
				<tr>
					<td colspan=\"2\"><hr style=\"width:95%;text-align:left\"></td>
				</tr>".(USER_STATUS < 10 && is_array($lotArray) ? "
				<tr>
					<td class=\"smallfont\" style=\"width:75px;font-weight:bold;\">Lot: </td>
					<td class=\"smallfont\">".select("lot_no",$lotArray,$_REQUEST['lot_no'],$lotArrayInside)."</td>
				</tr>
				<tr>
					<td colspan=\"2\"><hr style=\"width:95%;text-align:left\"></td>
				</tr>" : NULL)."
				<tr>
					<td class=\"smallfont\" style=\"width:75px;font-weight:bold;\">$err[1]Date: </td>
				...
				<tr>
					<td class=\"smallfont\" style=\"vertical-align:top;width:75px;font-weight:bold;\">Time:</td>
					<td class=\"smallfont\">
				...
				<tr>
					<td class=\"smallfont\" style=\"vertical-align:top;width:75px;font-weight:bold;\">Notes: </td>
				...
				<tr>
					<td class=\"smallfont\" style=\"width:75px;font-weight:bold;vertical-align:top;\">Repeating: </td>
					<td class=\"smallfont\">";
					if ($_REQUEST['repeating'] == "**") 
				...
				<tr>
					<td class=\"smallfont\" style=\"width:75px;font-weight:bold;vertical-align:top;\">$err[2]Reminders: </td>
					<td class=\"smallfont\">
